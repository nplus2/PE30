...
.controller('EvenementsCtrl', function($scope,requeteHttp,identification) {
  $scope.listeMessages = [];
  $scope.listeVisites = [];
  data = '[{"id_visite" : "1", "heure" : "1235", "nom" : "Labo", "couleur" : "vert"},{"id_visite" : "1", "heure" : "1245", "nom" : "Learning Lab", "couleur" : "bleu"},{"id_visite" : "1", "heure" : "1315", "nom" : "Vie de Campus", "couleur" : "rose"}]';
